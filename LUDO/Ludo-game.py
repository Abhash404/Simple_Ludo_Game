...
engine.say('namaste!')
engine.say("passaako ludo game maa swagot chaa")
engine.runAndWait()
...
def board():                            #Drawing the board, piece by piece.
                                        ...
                                        #Splash Screen.
    tkinter.messagebox.showinfo(title=None, message="पासाको लुडो खेलमा हजुरलाइ स्वागत छ !!")
    v = 0
    z = 0
...
def turn():   #Prints whoose turn is it
    ...
    if RED == True:
        L2 = Label(root, text="   पासाको पालो    ", fg='Black', background='green', font=("Arial", 24, "bold"))
        L2.place(x=770, y=50)

    if BLUE == True:
        L2 = Label(root, text="   याबुको पालो   ", fg='Black', background='green', font=("Arial", 24, "bold"))
        L2.place(x=770, y=50)

    if GREEN == True:
        L2 = Label(root, text="सरकारको पालो  ", fg='Black', background='green', font=("Arial", 24, "bold"))
        L2.place(x=770, y=50)

    if YELLOW == True:
        L2 = Label(root, text=".....को पालो", fg='Black', background='green', font=("Arial", 24, "bold"))
        L2.place(x=770, y=50)
...
def roll():   #Rolling function that rolls a dice, goes again if its a six
    ...
    if TURN == True:
        ...
        rollc = rollc + 1
        print("गाेटि फ्याक्नुहाेस: ", rollc)
...
def movecheck(r, rh, rb, la):       #Check if the player can make a move
    ...
    if win == True:                                         #If all gamepieces home, prints that the player has won
        print("बधाई छ !")
        L2 = Label(root, text=(la + "ले जित्नुभयो"), fg='Black', background='green', font=("Arial", 24, "bold"))
...
button = Button(root, text="   गाेटि फ्याक्नुहाेस   ", relief="raised", font=("Arial", 20),
